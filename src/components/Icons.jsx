export function Icon({ name, size = 24, strokeWidth = 1.8, className = '' }) {
  const paths = {
    ...
    eyeOff: <><path d="m3 3 18 18"/><path d="M10.6 5.1A10.7 10.7 0 0 1 12 5c6.5 0 10 7 10 7a17.8 17.8 0 0 1-3.2 4.2M6.6 6.6C3.8 8.6 2 12 2 12s3.5 7 10 7a10 10 0 0 0 5.4-1.6"/><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2"/></>,
    phone: <><rect x="7" y="2.5" width="10" height="19" rx="2"/><path d="M10 5h4M11.5 18.5h1"/></>,
    lock: <><rect x="4" y="10" width="16" height="11" rx="2"/><path d="M8 10V7a4 4 0 0 1 8 0v3M12 14v3"/></>,
    shield: <><path d="M12 2 20 5v6c0 5-3.5 8.7-8 11-4.5-2.3-8-6-8-11V5Z"/><path d="m9.5 12 1.7 1.7 3.6-4"/></>,
